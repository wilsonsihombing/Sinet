              ...
              <section class="section-profile">
                ...
                <div class="row justify-content-center profile-img">
                  <div class="col-md-4 col-sm-6 mb-3 text-left">
                    <img
                      src="frontend/images/isdeveloper.webp"
                      alt="isdeveloper"
                      class="img-fluid"
                    />
                  ...
                  <div class="col-md-4 col-sm-6 mb-3 text-left">
                    <img
                      src="frontend/images/data science.webp"
                      alt="datascience"
                      class="img-fluid"
                    />
                  ...
                  <div class="col-md-4 col-sm-6 mb-3 text-left">
                    <img
                      src="frontend/images/teacher.png"
                      alt="teacher"
                      class="img-fluid costume-img"
                    />
            ...
            <section class="section-events-content" id="eventsContent">
              <div class="section-event-program row justify-content-center g-3">
                <div class="col-sm-6 col-md-4 col-lg-3">
                  <img
                    src="frontend/images/event1.JPG"
                    alt="event"
                    class="costume-event img-fluid"
                  />
                </div>
      
                <div class="col-sm-6 col-md-4 col-lg-3">
                  <img
                    src="frontend/images/event2.png"
                    alt="event"
                    class="costume-event img-fluid"
                  />
                </div>
                ...
                <div class="col-sm-6 col-md-4 col-lg-3">
                  <img
                    src="frontend/images/event3.png"
                    alt="event"
                    class="costume-event img-fluid"
                  />
                </div>
                ...
                <div class="col-sm-6 col-md-4 col-lg-3">
                  <img
                    src="frontend/images/event4.png"
                    alt="event"
                    class="costume-event img-fluid"
                  />
                </div>
